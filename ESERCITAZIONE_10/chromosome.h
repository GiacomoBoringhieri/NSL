...
class Chromosome{
    ...
    public:
        ...
        // Nuovo: Ritorna il percorso come vector di indici
        vector<int> getAsVector() const;
    
        // Nuovo: Imposta il cromosoma da un vector di indici
        void setFromVector(const vector<int>& percorso);
    
        // Nuovo: Ritorna l'indice del gene alla posizione i
        int getGeneIndex(int i) const;
    
        // Nuovo: Imposta l'indice del gene alla posizione i
        void setGeneIndex(int i, int index);
